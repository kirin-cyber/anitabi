...
// Q1×Q2の15パターンに対応する診断タイプ名（シェアテキスト用）
export const DIAGNOSIS_TYPE_NAMES: Record<string, string> = {
  "笑いたい:アクション派":     "爆笑バトル型",
  "笑いたい:ストーリー派":     "ほっこりドラマ型",
  "笑いたい:どっちも好き":     "天然コメディ型",
  "泣きたい:アクション派":     "熱血感動型",
  "泣きたい:ストーリー派":     "泣き上手型",
  "泣きたい:どっちも好き":     "感動マスター型",
  "ドキドキしたい:アクション派": "爆走アクション型",
  "ドキドキしたい:ストーリー派": "謎解きハンター型",
  "ドキドキしたい:どっちも好き": "スリル好き型",
  "ゾクゾクしたい:アクション派": "ホラーファイター型",
  "ゾクゾクしたい:ストーリー派": "ダーク探偵型",
  "ゾクゾクしたい:どっちも好き": "絶叫マニア型",
  "癒されたい:アクション派":   "ほのかアクション型",
  "癒されたい:ストーリー派":   "癒しストーリー型",
  "癒されたい:どっちも好き":   "のんびり派型",
};
